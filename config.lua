...
vim.api.nvim_create_autocmd("VimEnter", { pattern = {"*"}, command = "set fdm=indent fdl=1" })
vim.api.nvim_create_autocmd("VimEnter", { pattern = {"*"}, command = "hi SignColumn guibg=none" })
vim.api.nvim_create_autocmd("WinNew", { pattern = {"*"}, command = "setlocal cursorline cursorcolumn" })
vim.api.nvim_create_autocmd("WinNew", { pattern = {"*"}, command = "hi CursorColumn guibg=#443960 gui=bold" })
vim.api.nvim_create_autocmd("WinNew", { pattern = {"*"}, command = "hi CursorLine guibg=#443960 gui=bold,underline" })
vim.api.nvim_create_autocmd("WinEnter", { pattern = {"*"}, command = "setlocal cursorline cursorcolumn" })
vim.api.nvim_create_autocmd("WinEnter", { pattern = {"*"}, command = "hi CursorColumn guibg=#443960 gui=bold" })
vim.api.nvim_create_autocmd("WinEnter", { pattern = {"*"}, command = "hi CursorLine guibg=#443960 gui=bold,underline" })
vim.api.nvim_create_autocmd("WinLeave", { pattern = {"*"}, command = "setlocal nocursorline nocursorcolumn" })
vim.api.nvim_create_autocmd("WinLeave", { pattern = {"*"}, command = "hi CursorColumn guibg=None gui=None" })
vim.api.nvim_create_autocmd("WinLeave", { pattern = {"*"}, command = "hi CursorLine guibg=None gui=None,underline" })
vim.api.nvim_create_autocmd("BufWritePre", { pattern = {"*.js", "*.jsx", "*.ts", "*.tsx"}, command = "lua vim.fn.Format_sync_sel_first()" })
